        ...
        {step === 'select' && phone && (
          <div>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-xl font-black text-slate-950">гд{pkg.price}</div>
                      {pkg.popular && (
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? t('creating_order') : `${t('recharge_pay')} гд${selectedPkg.price}`}
            </button>
          ...
          <div>
            {qrDataUrl ? (
              <div className="text-center">
                ...
                <p className="mt-3 text-lg font-bold text-slate-950">гд{selectedPkg.price}</p>
